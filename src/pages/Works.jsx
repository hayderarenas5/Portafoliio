    ...
    <PlayLayout>
      <section className="text-[#21243D] px-2 md:w-[85%] md:mx-auto ">
        <div className="flex justify-between">
          <h1 className="text-2xl font-bold py-2 dark:text-white">Trabajos</h1>
          <button className="dark:hover:text-slate-400 dark:text-white" onClick={handleOpenModal}><IconHelpCircle/></button>
        </div>
        <hr className=" w-[10px]"/>
        <Link to="https://taupe-duckanoo-804b9a.netlify.app/">
        <div className="hover:bg-primary dark:hover:bg-slate-400 dark:text-white rounded-md transition-colors md:grid md:grid-cols-2 md:items-center py-3">
          <header>
